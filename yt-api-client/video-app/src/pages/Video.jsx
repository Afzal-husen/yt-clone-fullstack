...
import { ThumbUpOutlined,
 ...
 import { Comments, Card, Recommendation} from "../components/utils/allComponents.js"    
        ...
        <Details>
          ...
          <Buttons>
            <Button onClick={handleLike}>
              { currentVideo.Liked.includes(currentUser._id) ? <ThumbUpAlt /> : <ThumbUpOutlined />} {currentVideo.Liked.length} Likes
            </Button>
            <Button onClick={handleDisLike}>
              { currentVideo.disLiked.includes(currentUser._id) ? <ThumbDownAlt /> : <ThumbDownOutlined />}Dislike
            </Button>
        ...
        <Channel>
          ...
          <SubscribeContainer >
            <SubscribeButton  onClick={handleSubscription}>
              { currentUser.subscribedChannels.includes(currentUser._id) ? "UnSubscribe" : "Subscribe"}
            </SubscribeButton>
          </SubscribeContainer>
        </Channel>
        <Hr />
